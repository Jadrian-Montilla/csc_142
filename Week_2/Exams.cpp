...
/*
    Exams
    Calculates the average score of three exam scores.
    Jadrian Montilla
    01/29/2025
*/
...
int main() {
    ...
    std::cout << "\nName: " + name << std::endl;
    std::cout << "1st Exam score: " << exam1 << std::endl;
    std::cout << "2nd Exam score: " << exam2 << std::endl;
    std::cout << "3rd Exam score: " << exam3 << std::endl;
