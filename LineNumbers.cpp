...
/*
    LineNumbers
    The program reads each line in the given texts "Mary had a little lamb" and "War and Peace" and prints them in a numbered order starting from 1.
    Jadrian Montilla
    2/7/25
*/
...
int main() {
    ...
    std::cout << "\nWhich file would you like to read? \n(Enter 'm' fror 'Mary Had a Little Lamb.')\n(Enter 'w' for 'War and Peace.'): ";
